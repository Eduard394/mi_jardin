    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <button type="button" class="btn btn-box-tool"><i class="fa fa-file-pdf-o text-orange"></i></button>
        </div>
      </div>
      <div class="box-body">
            ...
            <table class="table table-bordered table-striped table-responsive">
                ...
                <tbody>
                    <tr v-for="item in paginatedUsers" :key="item.id">
                        ...
                        <td><a class="btn btn-success btn-sm text-white" :href="'/proyecto/' +  item.slug  ">Ver</a></td>
                        <td><a class="btn btn-info btn-sm text-white" :href="'/proyecto/' +  item.slug + '/formulario' ">
                        Formulario</a>
                        </td>
                        <td><a class="btn btn-info btn-sm text-white" :href="'/proyecto/' +  item.slug + '/calificacion' ">
                        Evaluación</a>
                        </td>   
                    </tr>
                </tbody>
            </table>
            <div class="card-footer bg-transparent border-cyan">Lista de proyectos </div>
            <div>
...
export default {
    ...
    data() {
        ...
        let columns = [
            ...
            {label: 'Convocatoria', name: 'convocatori_id' },
        ];
    ...
    methods: {
        getRoles() {
            axios.get('/proyecto', {params: this.tableShow})
                .then(response => {
