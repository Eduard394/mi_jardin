   ...
   <div class="box">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <button type="button" class="btn btn-box-tool"><i class="fa fa-life-buoy text-orange"></i></button>
        </div>
      </div>
      <div class="box-body">
            ...
            <table class="table table-bordered table-striped table-responsive">
                ...
                <tbody>
                    <tr v-for="item in paginatedUsers" :key="item.id">
                        ...
                        <td  v-if="item.formulario == true" class="text-success" ><v-icon class="text-success">mdi-check-underline</v-icon></td>
                        <td v-else ><v-icon class="text-danger">mdi-close-circle</v-icon></td>

                        <td><a class="btn btn-success btn-sm text-white" :href="'/convocatoria/' +  item.slug  ">Ver</a></td>
                        <td><a class="btn btn-success btn-sm text-white" :href="'/convocatoria/' +  item.slug + '/porcentaje'  ">Porcentaje</a></td>
                        <td><a class="btn btn-info btn-sm text-white" :href="'/convocatoria/' +  item.slug + '/criterio' ">Criterio</a></td>
                        <td><a class="btn btn-info btn-sm text-white" :href="'/convocatoria/' +  item.slug+ '/formulario' ">Formulario</a></td>   
                    </tr>
                </tbody>
            </table>
            <div class="card-footer bg-transparent border-cyan">Lista de convocatorias </div>
            <div>
...
export default {
    ...
    data() {
        ...
        let columns = [
            ...
            {label: 'Estado formulario', name: 'formulario' },
        ];
    ...
    methods: {
        getRoles() {
            axios.get('/convocatoria/alluser', {params: this.tableShow})
                .then(response => {
