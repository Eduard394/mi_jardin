      ...
      <div class="box-header with-border">
        ...
        <div class="users-style">
            ...
            <table class="table table-bordered table-striped table-responsive">
                ...
                <tbody>
                    <tr v-for="rol in paginatedUsers" :key="rol.id">
                        <td >{{rol.nombre}}</td>
                        <td>{{rol.slug}}</td>
                        <td>{{rol.descripcion}}</td>
                        <td v-if="rol.super_admin == 'yes'" class="fa fa-thumbs-o-up mr-3 text-success fa-fw" ></td>
                        <td v-else class="fa fa-thumbs-o-down mr-3 text-danger fa-fw" ></td>
                        <td><a class="btn btn-warning btn-sm text-white" :href="'/roles/' +  rol.id  ">Ver</a></td>
                        <td><a class="btn btn-success btn-sm text-white" :href="'/roles/' +  rol.id + '/edit' ">Editar</a></td>
                        
                    </tr>
                </tbody>
            </table>
            <div class="card-footer bg-transparent border-cyan">Lista de roles </div>
            <div>
...
export default {
    ...
    data() {
        ...
        let columns = [
            ...
            {label: 'Administrador', name: 'super_admin'},
        ];
    ...
    methods: {
        getRoles() {
            axios.get('/roles', {params: this.tableShow})
                .then(response => {
