       ...
       <div class="box box-secondary">
          <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
              <button type="button" class="btn btn-box-tool" ><i class="fa fa-user text-orange"></i></button>
            </div>
          </div>
          <div class="box-body">
            <div class="users-style">
                ...
                <table class="table table-bordered table-striped table-responsive">
                    ...
                    <tbody>
                        <tr v-for="persona in paginatedUsers" :key="persona.id">
                            <td >{{persona.nombre}}</td>
                            <td>{{persona.documento}}</td>
                            <td>{{persona.telefono}}</td>
                            <td>{{persona.sexo}}</td>
                            <td><a class="btn btn-success btn-sm text-white" :href="'/persona/' +  persona.slug  ">Detalles</a></td>
...
export default {
    ...
    methods: {
        getPersonas() {
            ...
            axios.get('/persona', {params: this.tableShow})
                .then(response => {
                    this.progreso = false
